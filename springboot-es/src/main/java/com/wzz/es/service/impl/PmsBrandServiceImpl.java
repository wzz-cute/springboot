...
import com.wzz.es.mapper.PmsBrandMapper;
...
public class PmsBrandServiceImpl implements IPmsBrandService
{
     ...
     */
    @Override
    public int deletePmsBrandByBrandIds(String brandIds)
    {
        return pmsBrandMapper.deletePmsBrandByBrandIds(Convert.toStrArray(brandIds));
    }
